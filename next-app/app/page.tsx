...
export default function Home() {
  ...
  const tools: Tool[] = [
    ...
    },
    {
      icon: '📁',
      name: '文件查看器',
      description: '浏览、搜索、上传本地文件，支持图片、视频、PDF 预览',
      href: '/file-viewer/',
      tags: ['文件管理', '推荐'],
    },
    {
      icon: '📄',
      name: 'CSV 转 JSON',
      description: '前端直接解析 CSV 文件，支持自定义分隔符、表头',
      href: '/csv-to-json/',
      tags: ['数据转换', '前端解析'],
    },
    {
      icon: '📊',
      name: 'XLSX 转 JSON',
      description: '解析 Excel 文件，支持多工作表',
      href: '/xlsx-parser/',
      tags: ['数据转换', 'Excel'],
    },
    {
    ...
    },
    {
      icon: '📅',
      name: '日历管理',
      description: '基于 FullCalendar 的日历管理，支持任务添加',
      href: '/calendar/',
  ...
  const versions: Version[] = [
    ...
    },
    {
      ...
      href: '/todo-v6/',
      features: ['推荐', 'Composition API', '生产就绪'],
      recommended: true,
      color: '#f59e0b',
    },
    {
      ...
      tech: 'React 18 + Ant Design v5',
      href: '/todo-v7/',
      features: ['新', '推荐', '企业级 UI'],
      new: true,
      recommended: true,
      color: '#ef4444',
    },
