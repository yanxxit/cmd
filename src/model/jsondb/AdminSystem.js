...
const PERMISSION_CATALOG = [
  ...
  { key: 'jsondb.view', group: '数据库', label: '查看 JSONDB', description: '可查看 JSONDB 数据库、表列表并执行只读 SQL 查询' },
  ...
  { key: 'calendar.view', group: '日期管理', label: '查看日历列表', description: '可查看日期管理中的日历聚合视图' },
  { key: 'pomodoro.view', group: '日期管理', label: '查看番茄时钟', description: '可查看番茄记录、统计与设置' },
  { key: 'pomodoro.manage', group: '日期管理', label: '管理番茄时钟', description: '可新增、删除番茄记录并维护番茄设置' },
  { key: 'todos.view', group: '日期管理', label: '查看 TODO 列表', description: '可查看 TODO 任务列表、时间范围与状态' },
  { key: 'todos.manage', group: '日期管理', label: '管理 TODO 列表', description: '可新增、编辑、删除 TODO 任务并配置跨天范围' },
