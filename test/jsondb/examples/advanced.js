...
// 查询嵌套字段
const beijingEmployees = employees.find({
...
const updated = inventory.findOne({ item: 'Widget' });
...
// 创建索引
const index = books.createIndex({ author: 1 });
console.log('创建索引:', index);

// 列出索引
const indexes = books.listIndexes();
